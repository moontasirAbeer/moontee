...
//JETPACK START
MACRO_TUNING_PARAM(JetPackImpulse, jetpack_impulse, 4.0f)
MACRO_TUNING_PARAM(JetPackControl, jetpack_control, 150.0f / TicksPerSecond)
MACRO_TUNING_PARAM(JetPackAccel, jetpack_accel, 0.5f)
MACRO_TUNING_PARAM(JetPackFriction, jetpack_friction, 1.3f)
//JETPACK END

MACRO_TUNING_PARAM(HookLength, hook_length, 500.0f)
